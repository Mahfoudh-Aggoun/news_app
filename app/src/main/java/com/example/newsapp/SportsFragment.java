...
public class SportsFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Article>>, RecyclerItemClickListener {
    ...
    public void onViewCreated(View view, @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        nextPageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loaderManager.restartLoader(ARTICLE_LOADER_ID, null, SportsFragment.this);
            }
        });
